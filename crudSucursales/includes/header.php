        ...
        <ul id="navbarSupportedContent" class="flex flex-col gap-5">
          ...
          <a class="hover:text-gray-400" href="../crudSucursales/createSucursal.php">Sucursales</a>
            <ul class="flex flex-col gap-3 pl-20">
              <a class="<?= ($_SERVER['PHP_SELF'] == '/Finallp2/crudSucursales/createSucursal.php') ? 'text-sky-500' : 'text-white' ?>" href="createSucursal.php">Crear nueva sucursal</a>
              <a class="<?= ($_SERVER['PHP_SELF'] == '/Finallp2/crudSucursales/readSucursal.php') ? 'text-sky-500' : 'text-white'; ?>" href="readSucursal.php">Mostrar sucursales</a>
