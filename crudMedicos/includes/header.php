      ...
      <div class="flex flex-col gap-20">
        ...
        <ul id="navbarSupportedContent" class="flex flex-col gap-5">
          ...
          <ul class="flex flex-col gap-3 pl-20">
            <a class="<?= ($_SERVER['PHP_SELF'] == '/Finallp2/crudMedicos/createMedico.php') ? 'text-sky-500' : 'text-white' ?>" href="createMedico.php">Crear nuevo medico</a>
            <a class="<?= ($_SERVER['PHP_SELF'] == '/Finallp2/crudMedicos/readMedico.php') ? 'text-sky-500' : 'text-white'; ?>" href="readMedico.php">Mostrar medicos</a>
            <a class="<?= ($_SERVER['PHP_SELF'] == '/Finallp2/crudMedicos/updateMedico.php') ? 'text-sky-500' : 'text-white'; ?>" href="updateMedico.php">Editar</a>
            <a class="<?= ($_SERVER['PHP_SELF'] == '/Finallp2/crudMedicos/deleteMedico.php') ? 'text-sky-500' : 'text-white'; ?>" href="deleteMedico.php">Eliminar</a>
          </ul>
